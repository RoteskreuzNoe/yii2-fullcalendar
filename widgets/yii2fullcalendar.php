 ...
 * @copyright MaGiCmAsTeR0511 - www.frenzel.net
 * @link http://www.frenzel.net
 * @author MaGiCmAsTeR0511 <kurt.hohenauer@n.roteskreuz.at>
 *
 */

namespace yii2fullcalendar\widgets;
...
class yii2fullcalendar extends Widget
{
     ...
     * @var string the javascript code that implements the eventMouseover function
     */
    ...
    protected function registerPlugin()
    {
        ...
        if (array_key_exists(
                'defaultView',
                $this->clientOptions
            ) && ($this->clientOptions['defaultView'] == 'timelineDay' || $this->clientOptions['defaultView'] == 'timelineWeek' || $this->clientOptions['defaultView'] == 'timelineMonth' || $this->clientOptions['defaultView'] == 'agendaDay')) {
